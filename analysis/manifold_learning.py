...
#                                      eigen_solver='auto')
#X_lle = lle.fit_transform(data_scaled)

isomap = manifold.TSNE(n_components=2, init='pca', random_state=1,
                       perplexity=50)#manifold.Isomap(n_neighbors, out_dim)
...
plt.scatter(X_isomap[:, 0], X_isomap[:, 1], marker='.')
